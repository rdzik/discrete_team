...
```python
### Your code here
# skewed because it is skewed and without outliers
...
# sns.histplot(data = df_2007['population'], color='yellow')

#Bonus 1
#sns.histplot(data = df_2007['population'], stat='probability')

#Bonus 2
#this graph has negative skewness
sns.histplot(data = df_2007['population'], log_scale=5)
```
